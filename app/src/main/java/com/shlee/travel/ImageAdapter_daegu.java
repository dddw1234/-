...
public class ImageAdapter_daegu extends BaseAdapter {
    private Context mContext;

    public ImageAdapter_daegu(Context c){
        mContext = c;
    }
    public int getCount(){
    ...
    private Integer[] mThumbIds = {//drawble리소스에 있는값들을 모아서 하나의 배열로 정의
            R.drawable.daegu_1, R.drawable.daegu_2,
            R.drawable.daegu_3, R.drawable.daegu_4,
            R.drawable.daegu_5, R.drawable.daegu_6,
            R.drawable.daegu_7, R.drawable.daegu_8,
            R.drawable.daegu_9, R.drawable.daegu_10
    };
}
