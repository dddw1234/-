...
public class ImageAdapter_ulsan extends BaseAdapter {
    private Context mContext;

    public ImageAdapter_ulsan(Context c){
        mContext = c;
    }
    public int getCount(){
    ...
    private Integer[] mThumbIds = {//drawble리소스에 있는값들을 모아서 하나의 배열로 정의
            R.drawable.ulsan_1, R.drawable.ulsan_2,
            R.drawable.ulsan_3, R.drawable.ulsan_4,
            R.drawable.ulsan_5, R.drawable.ulsan_6,
            R.drawable.ulsan_7, R.drawable.ulsan_8,
            R.drawable.ulsan_9, R.drawable.ulsan_10
    };
}
