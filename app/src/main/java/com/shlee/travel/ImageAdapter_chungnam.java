...
public class ImageAdapter_chungnam extends BaseAdapter {
    private Context mContext;

    public ImageAdapter_chungnam(Context c){
        mContext = c;
    }
    public int getCount(){
    ...
    private Integer[] mThumbIds = {//drawble리소스에 있는값들을 모아서 하나의 배열로 정의
            R.drawable.chungnam_1, R.drawable.chungnam_2,
            R.drawable.chungnam_3, R.drawable.chungnam_4,
            R.drawable.chungnam_5, R.drawable.chungnam_6,
            R.drawable.chungnam_7, R.drawable.chungnam_8,
            R.drawable.chungnam_9, R.drawable.chungnam_10
    };
}
