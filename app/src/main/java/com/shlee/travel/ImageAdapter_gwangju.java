...
public class ImageAdapter_gwangju extends BaseAdapter {
    private Context mContext;

    public ImageAdapter_gwangju(Context c){
        mContext = c;
    }
    public int getCount(){
    ...
    private Integer[] mThumbIds = {//drawble리소스에 있는값들을 모아서 하나의 배열로 정의
            R.drawable.gwangju_1, R.drawable.gwangju_2,
            R.drawable.gwangju_3, R.drawable.gwangju_4,
            R.drawable.gwangju_5, R.drawable.gwangju_6,
            R.drawable.gwangju_7, R.drawable.gwangju_8,
            R.drawable.gwangju_9, R.drawable.gwangju_10
    };
}
