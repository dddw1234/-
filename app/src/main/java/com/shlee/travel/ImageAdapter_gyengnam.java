...
public class ImageAdapter_gyengnam extends BaseAdapter {
    private Context mContext;

    public ImageAdapter_gyengnam(Context c){
        mContext = c;
    }
    public int getCount(){
    ...
    private Integer[] mThumbIds = {//drawble리소스에 있는값들을 모아서 하나의 배열로 정의
            R.drawable.gyengnam_1, R.drawable.gyengnam_2,
            R.drawable.gyengnam_3, R.drawable.gyengnam_4,
            R.drawable.gyengnam_5, R.drawable.gyengnam_6,
            R.drawable.gyengnam_7, R.drawable.gyengnam_8,
            R.drawable.gyengnam_9, R.drawable.gyengnam_10
    };
}
