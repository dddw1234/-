...
public class ImageAdapter_jeonnam extends BaseAdapter {
    private Context mContext;

    public ImageAdapter_jeonnam(Context c){
        mContext = c;
    }
    public int getCount(){
    ...
    private Integer[] mThumbIds = {//drawble리소스에 있는값들을 모아서 하나의 배열로 정의
            R.drawable.jeonnam_1, R.drawable.jeonnam_2,
            R.drawable.jeonnam_3, R.drawable.jeonnam_4,
            R.drawable.jeonnam_5, R.drawable.jeonnam_6,
            R.drawable.jeonnam_7, R.drawable.jeonnam_8,
            R.drawable.jeonnam_9, R.drawable.jeonnam_10
    };
}
