...
public class ImageAdapter_busan extends BaseAdapter {
    private Context mContext;

    public ImageAdapter_busan(Context c){
        mContext = c;
    }
    public int getCount(){
    ...
    private Integer[] mThumbIds = {//drawble리소스에 있는값들을 모아서 하나의 배열로 정의
            R.drawable.busan_1, R.drawable.busan_2,
            R.drawable.busan_3, R.drawable.busan_4,
            R.drawable.busan_5, R.drawable.busan_6,
            R.drawable.busan_7, R.drawable.busan_8,
            R.drawable.busan_9, R.drawable.busan_10
    };
}
