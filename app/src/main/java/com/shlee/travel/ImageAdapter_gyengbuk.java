...
public class ImageAdapter_gyengbuk extends BaseAdapter {
    private Context mContext;

    public ImageAdapter_gyengbuk(Context c){
        mContext = c;
    }
    public int getCount(){
    ...
    private Integer[] mThumbIds = {//drawble리소스에 있는값들을 모아서 하나의 배열로 정의
            R.drawable.gyengbuk_1, R.drawable.gyengbuk_2,
            R.drawable.gyengbuk_3, R.drawable.gyengbuk_4,
            R.drawable.gyengbuk_5, R.drawable.gyengbuk_6,
            R.drawable.gyengbuk_7, R.drawable.gyengbuk_8,
            R.drawable.gyengbuk_9, R.drawable.gyengbuk_10
    };
}
